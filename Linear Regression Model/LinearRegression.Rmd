...
Yes! Both forward and backward selection produced the same final model: 

This means both methods agree that "severity" does not contribute significantly to the model and should be removed. 

Intercept: 145.941228 
